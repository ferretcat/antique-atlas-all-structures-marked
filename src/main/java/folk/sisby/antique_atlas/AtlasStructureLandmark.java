...
public record AtlasStructureLandmark(BlockPos pos, StructureTileProviders.ProviderType providerType,
        Identifier providedId, String loll) implements Landmark<AtlasStructureLandmark> {
